...
(function() {
    ...
    var globalPropArray =  axs.constants.ARIA_ROLES['roletype'].properties;
    globalPropArray.forEach(function(property) {
        axs.constants.GLOBAL_PROPERTIES[property] = true;
    });
})();
