...
test("Element exists, single aria-labelledby value", function() {
    ...
    deepEqual(AuditRules.rules.nonExistentAriaLabelledbyElement.run(fixture),
...
test("Element doesn't exist, single aria-labelledby value", function() {
    ...
    var result = AuditRules.rules.nonExistentAriaLabelledbyElement.run(fixture);
    equal(result.result, AuditResult.FAIL);
